...
{
    public string $table = Division::TABLE_NAME;

    public string $model='Modules\Hrm\Entities\Division';
    ...
    protected function filterSearchQuery(Builder|EloquentBuilder $query, string $searchedText): Builder
    {
        ...
        return $query->where('divisions.name', 'LIKE', $searchable)
            ->orWhere('divisions.code', 'LIKE', $searchable);
    }
