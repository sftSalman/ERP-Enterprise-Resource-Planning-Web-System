...
import { getActivityLogListAction } from '@/redux/actions/auth-action';
...
export default function ActivityLog() {
    ...
    const { activityLogList, activityLogListPaginationData, isLoading } = useSelector((state: RootState) => state.Auth);
    ...
    const debouncedDispatch = useCallback(
        debounce(() => {
            dispatch(getActivityLogListAction(currentPage, dataLimit, searchText))
        }, 500),
            ...
            <PageContentList>
                {
                    isLoading ?
                        ...
                        <Table
                            ...
                            dataLimit={dataLimit}
                            totalData={activityLogListPaginationData.total}
                        >
                            {
                                activityLogList && activityLogList.length > 0 && activityLogList.map((department: IdepartmentView, index: index) => (
